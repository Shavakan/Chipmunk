...
export const getBookmarks = async (user_id = default_user_id) => await axios.get(`${URL}/${user_id}/channels/bookmarks.json`);

// https://chipmunk-89590.firebaseio.com/users/dc4b3b02-a31a-11ea-bb37-0242ac130002/channels/bookmarks/.json
export const getBookmark = async (bookmark_id: any, user_id = default_user_id) => await axios.get(`${URL}/${user_id}/channels/bookmarks/${bookmark_id}.json`);
...
export const getConnections = async (user_id = default_user_id) => await axios.get(`${URL}/${user_id}/channels/connections.json`);
...
export const setConnectionType = async (uuid: string, type: string) => {
    await axios.put(`${URL}/${default_user_id}/channels/connections/${uuid}/type`, type);
}